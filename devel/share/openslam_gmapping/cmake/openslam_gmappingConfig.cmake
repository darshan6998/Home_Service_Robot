...
if("TRUE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /home/robond/p5/src/package folder/openslam_gmapping)
  set(openslam_gmapping_DEVEL_PREFIX /home/robond/p5/devel)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /home/robond/p5/install)
...
if(NOT "/home/robond/p5/src/package folder/openslam_gmapping/include " STREQUAL " ")
  set(openslam_gmapping_INCLUDE_DIRS "")
  set(_include_dirs "/home/robond/p5/src/package folder/openslam_gmapping/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robond/p5/src/package folder/openslam_gmapping/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robond/p5/devel/lib;/home/robond/p5/devel/lib;/opt/ros/kinetic/lib)
